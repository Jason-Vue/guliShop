      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li v-if="searchParams.keyword" class="with-x">{{ searchParams.keyword }}<i @click="removeKeyword">x</i>
            </li>
            ...
            <li class="with-x" v-for="(prop, index) in searchParams.props" :key="index">{{ prop.split(":")[1] }}<i
                @click="removeProp(index)">X</i></li>
          </ul>
        </div>
        <!--selector-->
        <search-selector @getTradeMark="getTradeMark" @getProp="getProp"></search-selector>
        <!--details商品页-->
        <div class="details clearfix">
          <div class="sui-navbar">
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="handleSort('1')">
                  <a>综合<i class="iconfont" v-if="isOne" :class="{ iconup: isAsc, icondown: isDesc }"></i></a>
                </li>
                <li :class="{ active: isTwo }" @click="handleSort('2')">
                  <a>销量<i class="iconfont" v-if="isTwo" :class="{ iconup: isAsc, icondown: isDesc }"></i></a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <!-- 分页器 -->
          <Pagination :pageNo="pageNo" :pageSize="pageSize" :total="total" :totalPage="totalPage" :continueNum='5'
