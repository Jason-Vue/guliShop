...
export default {
  ...
  methods: {
    ...
    async open() {
      ...
      // 2.2 支付弹出框
      this.$alert(`<img src="${imgUrl}" />`, "请你使用微信支付", {
        ...
        beforeClose: (type, instance, done) => {
          ...
          // done：关闭弹框的方法
          if (type == "cancel") {
            this.$message.error("请联系管理员JASON");
      ...
      // 2.3 支付成功,路由跳转;支付失败,提示信息
      // 如何知道是否支付成功或者失败？我们有接口可以查询是否支付成功
      // 只要弹出框弹出来：那么就需要一直查询支付状态
      // 没有定时器，开启新的定时器
      if (!this.timer) {
